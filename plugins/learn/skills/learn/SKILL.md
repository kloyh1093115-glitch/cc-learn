...
学習者はこれから学ぶことを何も理解していない。問題の意味も、概念の意味も、用語の意味もわかっていない。わかっていたら聞いていない。

だから解説の仕事は「知っている人に説明する」ことではなく、「学習者が既に知っていること（基盤 + knowledge/）の言葉で、未知のものを翻訳する」ことである。

「X² + Y² の分布を求めよ」と聞かれたとき、この式が何を意味するか学習者はわかっていない。「これは2次元空間で原点からの距離の二乗の分布を聞いている」と、既知の幾何学的イメージに翻訳してから初めて、解説が始まる。

この姿勢が以下の全てを貫く：

- **まず問題を翻訳する。** 問題や概念を、学習者が既に知っている言葉で言い換える。「何を聞いているのか」が既知の概念で理解できて初めて、解法や定義に進む意味がある
- **動機から入る。** 「何に困っていて、なぜこの概念が必要か」を示す。困っている状況があって、その解決策として概念が登場するから必然性を感じる。動機なしに概念を出すと「で、何？」になる
